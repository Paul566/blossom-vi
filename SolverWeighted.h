...
class SolverWeighted {
    public:
        ...
        const std::vector<std::tuple<int, int, std::vector<int>>>& DualCertificate() const;
    ...
    private:
        ...
        std::vector<std::tuple<int, int, std::vector<int>>> dual_certificate;
        // (index, dual var, indices of blossom children)
