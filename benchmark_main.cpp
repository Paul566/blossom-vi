...
int main(int argc, char** argv) {
    TesterWeighted tester(false, 239);

    // const std::string benchmark_path_arg = argc > 1 ? argv[1] : "tests-weighted";
    const std::string benchmark_path_arg = argc > 1 ? argv[1] : "tests-weighted/instances-for-table";
    ...
    //tester.MeasureInstance("../tests-weighted/dense-random/random-3162-500000", 1, 20, false, false);
